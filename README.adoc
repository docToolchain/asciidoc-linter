...
asciidoc-lint --config .asciidoc-lint.yml document.adoc
----

=== Configuration

The linter can be configured using a YAML configuration file. By default, it looks for `.asciidoc-lint.yml` in the current directory.
