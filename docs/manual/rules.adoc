...
=== FMT001: Explicit Numbered Lists (Planned)

Will detect explicit numbered lists (`1.`, `2.`, etc.) and suggest using AsciiDoc dot-syntax (`.`).

=== FMT002: Non-semantic Definition Lists (Planned)

Will detect non-semantic definition list patterns and suggest using `Term:: Definition` syntax.

=== FMT003: Counter Syntax in Titles (Planned)

Will detect `{counter:...}` usage in section titles and suggest alternatives.
