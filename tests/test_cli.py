...
from asciidoc_linter.reporter import ConsoleReporter, JsonReporter, HtmlReporter, LintReport
...
class TestCliFileProcessing(unittest.TestCase):
    ...
    def test_lint_with_errors(self, mock_lint):
        ...
        mock_lint.return_value = LintReport([Finding(message="Foo", severity=Severity.ERROR)])  # Simulate lint error
